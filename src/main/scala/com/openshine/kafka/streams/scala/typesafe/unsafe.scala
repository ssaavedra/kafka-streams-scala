...
import com.openshine.kafka.streams.scala.typesafe.ImplicitConverters.ConverterToTypeSafer
...
/** Unsafe operations enabler.
  ...
  * [[com.openshine.kafka.streams.scala.typesafe.unsafe.UnsafelyWrapper]] which
  ...
  * [[ConverterToTypeSafer]] instance providing a conversion from Src to the
  * safe Dst.
  */
object unsafe {

  /** This class provides public `.unsafely` instances for
    * [[com.openshine.kafka.streams.scala.typesafe.TSKType]] values that may be
